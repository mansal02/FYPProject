...
class MarieVoice:
    def __init__(self, default_char="voice_01"):
        ...
        # 1. Properly set up initial character variables
        self.set_voice(default_char)
        
        # 2. Initialize Pygame Mixer and create the required audio channel
        ...
        # 3. FIX: Point target to the actual loop function '_process_queue'
